            ...
            <div className="container-fluid p-0">
                {activeView === 'dashboard' && (
                    <>
                        ...
                        {/* Subscription & License Management Row */}
                        <div className="row g-4 mb-4">
                            <div className="col-md-12">
                                <div className="dashboard-card">
                                    <div className="d-flex justify-content-between align-items-center mb-4">
                                        <div>
                                            <h6 className="dashboard-card-title mb-1">Subscription & License Management</h6>
                                            <p className="small text-secondary mb-0">Manage your plan, licenses, and billing details.</p>
                                        </div>
                                    ...
                                    <div className="row g-4 align-items-center">
                                        ...
                                        <div className="col-md-5">
                                            <div className="p-3 bg-light rounded-3 border">
                                                <div className="d-flex justify-content-between mb-2">
                                                    <span className="small fw-bold text-dark">License Usage</span>
                                                    <span className="small fw-bold text-primary">1308 / 2000 Users</span>
                                                </div>
                                                ...
                                                <div className="d-flex justify-content-between">
                                                    <small className="text-secondary" style={{ fontSize: '0.75rem' }}>692 Licenses Remaining</small>
                                                    <small className="text-danger fw-bold" style={{ fontSize: '0.75rem' }}>Expires: 31 Dec 2026</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-7">
                                            <div className="d-flex gap-3">
                                                {/* Free Plan */}
                                                <div className="flex-grow-1 p-3 rounded-3 border text-center" style={{ borderStyle: 'dashed !important' }}>
                                                    <h6 className="fw-bold fs-6 mb-1">Free Plan</h6>
                                                    <p className="small text-secondary mb-2">Up to 10 Employees</p>
                                                    <button className="btn btn-sm btn-outline-secondary w-100 disabled">Current (n/a)</button>
                                                </div>

                                                {/* Business Plan */}
                                                <div className="flex-grow-1 p-3 rounded-3 border border-primary bg-primary bg-opacity-10 text-center">
                                                    <h6 className="fw-bold fs-6 mb-1">Professional</h6>
                                                    <p className="small text-secondary mb-2">Up to 2000 Employees</p>
                                                    <button className="btn btn-sm btn-primary w-100">Active Plan</button>
                                                </div>

                                                {/* Enterprise Plan */}
                                                <div className="flex-grow-1 p-3 rounded-3 border text-center opacity-75">
                                                    <h6 className="fw-bold fs-6 mb-1">Enterprise</h6>
                                                    <p className="small text-secondary mb-2">Unlimited Users</p>
                                                    <button className="btn btn-sm btn-outline-dark w-100">Upgrade</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
