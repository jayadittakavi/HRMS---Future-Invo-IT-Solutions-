                        ...
                        <tbody>
                            {companies.map((company) => (
                                <tr key={company.id}>
                                    ...
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(company)}><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(company)}><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
