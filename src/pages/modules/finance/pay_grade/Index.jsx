                        ...
                        <tbody>
                            {payGrades.map((grade) => (
                                <tr key={grade.id}>
                                    ...
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(grade)} title="Edit"><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(grade)} title="Delete"><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
