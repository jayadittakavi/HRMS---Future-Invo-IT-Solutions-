...
export const NotificationProvider = ({ children }) => {
    ...
    const [notifications, setNotifications] = useState([
        { id: 1, title: 'New Message', message: 'You have received a new message from HR.', time: '2 mins ago', read: true, type: 'info' },
        { id: 2, title: 'System Update', message: 'The system will undergo maintenance at midnight.', time: '1 hour ago', read: true, type: 'warning' },
