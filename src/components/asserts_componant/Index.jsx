                        ...
                        <tbody>
                            {assets.map((asset) => (
                                <tr key={asset.id}>
                                    ...
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(asset)} title="Edit"><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(asset)} title="Delete"><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
