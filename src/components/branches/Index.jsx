                        ...
                        <tbody>
                            {branches.map((branch) => (
                                <tr key={branch.id}>
                                    ...
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(branch)} title="Edit"><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(branch)} title="Delete"><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
