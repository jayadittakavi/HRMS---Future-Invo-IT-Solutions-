                        ...
                        <tbody>
                            {years.map((fy) => (
                                <tr key={fy.id}>
                                    ...
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(fy)} title="Edit"><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(fy)} title="Delete"><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
