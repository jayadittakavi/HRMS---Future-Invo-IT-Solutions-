                        ...
                        <tbody>
                            {categories.map((cat) => (
                                <tr key={cat.id}>
                                    ...
                                    <td>{cat.created}</td>
                                    <td>
                                        <button className="action-btn edit" onClick={() => handleEdit(cat)} title="Edit"><FaEdit /></button>
                                        <button className="action-btn delete" onClick={() => handleDelete(cat)} title="Delete"><FaTrash /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
